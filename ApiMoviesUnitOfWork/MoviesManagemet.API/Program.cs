...
using MoviesManagement.DataAccess.Implementacion;
...
//DbContext
builder.Services.AddDbContext<MoviesManagementDbContext>(options => options.UseSqlServer(builder.Configuration.GetConnectionString("ConexionDb")));
